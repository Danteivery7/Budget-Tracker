...
const STATIC = ['/', '/index.html', '/styles.css', '/purchase-planner.css', '/professional.css', '/subscriptions.css', '/plan-change.css', '/plan-bootstrap.js', '/app.js', '/engine.js', '/refunds.js', '/start.js', '/allocations.js', '/cards.js', '/subscription-engine.js', '/subscriptions.js', '/purchase-engine.js', '/purchase-planner.js', '/setup-engine.js', '/setup-wizard.js', '/plan-change.js', '/ui-polish.js', '/manifest.webmanifest', '/icon.svg'];
